  ...
  return (
    <section ref={ref} className={cn('scroll-section', inView ? 'is-visible' : '')}>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto p-8 flex flex-col items-center text-center gap-6">
        <div className="animate-item" style={{ transform: 'translateX(-24px)', opacity: 0 }}>
        ...
        <p className="font-body text-base md:text-lg max-w-[65ch] animate-item" style={{ transitionDelay: '150ms', transform: 'translateX(-24px)', opacity: 0 }}>
        ...
        <div className={cn("my-4 animate-item")} style={{ transitionDelay: '300ms' }}>
        ...
        <div className="bg-[#F5F3E7E0] text-card-foreground p-6 md:p-7 rounded-[20px] border border-emerald-300/20 shadow-md backdrop-blur-md max-w-3xl animate-item w-full" style={{ transitionDelay: '450ms' }}>
