  ...
  return (
    <section ref={ref} className={cn('scroll-section', inView ? 'is-visible' : 'opacity-0')}>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto p-8 flex flex-col items-center text-center gap-6">
        ...
        <div className="bg-secondary/20 backdrop-blur-md text-card-foreground p-6 rounded-lg border border-primary/50 shadow-lg animate-item" style={{ animationName: 'fade-up', animationDelay: '0.8s' }}>
